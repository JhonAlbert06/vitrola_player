        ...
        <nav className="navbar" style={{"backgroundColor": "#e3f2fd"}}>
            <div className="container-fluid">
                <a className="navbar-brand" href="/">
                    <svg style={
                        {"marginLeft":"50px" }} xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" className="bi bi-music-note-list" viewBox="0 0 16 16">
                    ...
                    <h4 style={
                        { "display": "inline", "marginLeft":"20px", "fontSize": "24px" }
                    } >Music Player</h4>
                </a>
            </div>
        </nav>
